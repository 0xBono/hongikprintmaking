...
export const useMatter = () => {
  ...
  const engine = React.useRef(matterEngine);
  ...
  React.useEffect(() => {
    ...
    const texture_alphabet_r = Bodies.rectangle(1300, -340, 298, 364, {
      angle: -0.5,
      mass: 0,
      // frictionAir: 0.2,
      friction: 1,
    ...
    const texture_alphabet_r_s = Bodies.rectangle(1300, 0, 150, 210, {
      mass: 0,
      // frictionAir: 0.2,
      friction: 1,
      render: {
